  ...
  return (
    <main className="min-h-dvh bg-gradient-to-b from-white via-sky-50 to-white pb-24">
      <section className="overflow-hidden rounded-b-[32px] border-b border-blue-100 bg-gradient-to-br from-white via-sky-50 to-emerald-50 px-5 pb-6 pt-6 text-[#083a78] shadow-sm">
        <p className="text-sm font-semibold text-blue-700">ชำระเงิน</p>
        ...
        <div className="mt-5 rounded-[24px] border border-blue-100 bg-white/90 px-4 py-5 text-slate-950 shadow-sm">
      ...
      <section className="space-y-4 px-5 py-5">
        <div className="rounded-[24px] border border-blue-100 bg-white p-4 shadow-sm shadow-blue-950/5">
          <div className="mb-3 flex items-center gap-2">
            ...
            <h2 className="font-kanit text-lg font-bold text-slate-950">ช่องทางชำระเงิน</h2>
          </div>
          {transferAccount ? (
            <div className="space-y-2 text-sm">
              <p className="font-semibold text-slate-900">{transferAccount.bankName ?? transferAccount.name}</p>
              <div className="flex flex-wrap items-center justify-between gap-2 rounded-2xl bg-blue-50/60 px-3 py-2">
              ...
              <p className="rounded-2xl bg-[#e9f8f0] px-3 py-2 text-xs font-semibold text-emerald-800">
        ...
        <div className="space-y-3">
          {rows.length === 0 ? (
            <div className="rounded-[24px] border border-emerald-200 bg-emerald-50 px-4 py-8 text-center text-emerald-800 shadow-sm">
