  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-2">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-slate-300">สร้างเอกสารใหม่</span>
      </div>

      <h1 className="mb-6 font-kanit text-2xl font-bold text-gray-900 dark:text-slate-100">บันทึกเงินมัดจำซัพพลายเออร์</h1>
