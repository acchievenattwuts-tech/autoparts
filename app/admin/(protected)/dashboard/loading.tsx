  ...
  <div className="flex min-h-[60vh] items-center justify-center">
    ...
    >
      ...
      <div className="space-y-1">
        <p className="text-sm font-medium text-gray-700 dark:text-slate-100">กำลังโหลด Dashboard...</p>
        <p className="text-xs text-gray-500 dark:text-slate-400">ระบบกำลังเตรียมข้อมูลล่าสุด</p>
      </div>
