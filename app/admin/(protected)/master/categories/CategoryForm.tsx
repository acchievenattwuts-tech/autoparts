        ...
        <div className="min-w-0 flex-1 space-y-2">
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-slate-400">
              ...
              โดยไม่ตัดขอบ สินค้าจึงเห็นเต็มชิ้นและล้นวงกลมได้ ไม่ต้องเป็นรูปจัตุรัส ขอแค่กรอบชิดตัวสินค้า
              เลือกไฟล์แล้วจะให้ลากกรอบครอปได้อิสระก่อน ถ้าไม่แนบระบบจะใช้รูปสินค้าขายดีในหมวดนั้นให้อัตโนมัติ
            </p>
          </div>
