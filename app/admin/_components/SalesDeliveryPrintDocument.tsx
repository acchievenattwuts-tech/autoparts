        ...
        {sale.paymentType === "CREDIT_SALE" ? (
          <div className={`grid grid-cols-2 gap-0 ${PRINT_SECTION_BORDER_CLASS} text-center text-xs`}>
            {["ผู้ส่งของ", "ผู้รับของ"].map((label, i) => (
              <div key={label} className={i < 1 ? `border-r ${PRINT_BODY_BORDER_CLASS}` : ""}>
                <div className="h-16" />
                <div className={`${PRINT_SECTION_TOP_BORDER_CLASS} py-1.5 font-medium text-gray-900`}>{label}</div>
          ...
          <div className={`grid grid-cols-2 gap-0 ${PRINT_SECTION_BORDER_CLASS} text-center text-xs`}>
            <div className={`border-r ${PRINT_BODY_BORDER_CLASS}`}>
              ...
              <div className="px-4 pb-2 text-gray-600">วันที่ {documentDateText}</div>
            </div>
            <div>
              <div className="h-16" />
              <div className={`${PRINT_SECTION_TOP_BORDER_CLASS} py-1.5 font-medium text-gray-900`}>ผู้รับของ</div>
