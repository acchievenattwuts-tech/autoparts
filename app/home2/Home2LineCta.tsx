 ...
 *
 * Same content as the storefront's <LineCTA/>, restyled to home2: a rounded
 * navy card inside the page's max-w-7xl rhythm rather than a full-bleed band,
 * and the decorative orange glow swapped for blue — orange stays reserved for
 * prices. LINE green is kept, since that is the brand's own colour.
 */
const Home2LineCta = ({ shopName, lineId, lineUrl, lineQrUrl, shopPhone }: Props) => {
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pt-3 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-2xl bg-[#1e3a5f] px-5 py-10 sm:px-8 sm:py-12">
        <div
          aria-hidden="true"
        ...
        <div className="relative flex flex-col items-center gap-10 lg:flex-row lg:justify-between">
          <div className="text-center lg:text-left">
            ...
            <h2 className="mb-3 font-kanit text-2xl font-bold leading-tight text-white sm:text-3xl">
              สั่งซื้อง่าย ๆ
              <br />
            ...
            <div className="mt-6 flex flex-col justify-center gap-2.5 sm:flex-row lg:justify-start">
              {lineUrl && (
                <a
                  ...
                  className={`${STOREFRONT_LINE_PRIMARY_BUTTON_CLASS} px-7 py-3.5 text-base font-bold`}
                >
                  {LINE_ICON}
                  เพิ่มเพื่อนทาง LINE
                </a>
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/10 px-7 py-3.5 text-base font-semibold text-white transition-colors hover:bg-white/20"
              >
                โทรสอบถาม
              </a>
            </div>
          ...
          <div className="w-56 shrink-0 rounded-2xl bg-white p-6 text-center shadow-lg">
