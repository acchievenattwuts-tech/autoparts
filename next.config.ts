...
const nextConfig: NextConfig = {
  ...
  outputFileTracingIncludes: {
    ...
    "/opengraph-image": ["./lib/og-fonts/*.ttf", "./lib/og-assets/logo.png"],
    "/about/opengraph-image": ["./lib/og-fonts/*.ttf", "./lib/og-assets/logo.png"],
    "/faq/opengraph-image": ["./lib/og-fonts/*.ttf", "./lib/og-assets/logo.png"],
    "/knowledge/opengraph-image": ["./lib/og-assets/logo.png"],
    "/knowledge/*/opengraph-image": ["./lib/og-assets/logo.png"],
    "/products/*/opengraph-image": ["./lib/og-fonts/*.ttf", "./lib/og-assets/logo.png"],
    "/products/*/*/opengraph-image": ["./lib/og-fonts/*.ttf", "./lib/og-assets/logo.png"],
  },
