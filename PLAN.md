...
- [x] LIFF UX polish (2026-05-06): profile incomplete-data notice now directs customers to contact staff for personal-data edits, `/liff/warranties` status tabs show immediate loading feedback while filters navigate, and the LIFF customer portal was restyled to match the blue/white rich-menu theme across shell, headers, cards, bottom nav, loading, onboarding, print toolbars, and key list/detail pages
