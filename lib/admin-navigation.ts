...
export const ADMIN_NAVIGATION: readonly AdminNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "คืนเงินมัดจำลูกค้า",
        ...
        icon: RotateCcw,
        permission: "customer_advance_refunds.view",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "รับคืนเงินมัดจำซัพพลายเออร์",
        ...
        icon: RotateCcw,
        permission: "supplier_advance_refunds.view",
        keywords: "supplier advance refund cnadv รับคืนเงินมัดจำ ซัพพลายเออร์",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      { label: "ภาษีหัก ณ ที่จ่าย", href: "/admin/wht", icon: Receipt, permission: "wht.view", keywords: "wht withholding tax ภาษีหัก ณ ที่จ่าย 50 ทวิ ภงด ภ.ง.ด.3 ภ.ง.ด.53 ภ.ง.ด.94",
      },
      { label: "หนังสือรับรอง 50 ทวิ", href: "/admin/wht/certificates", icon: Receipt, permission: "wht.view", keywords: "wht certificate 50 ทวิ หนังสือรับรอง หักภาษี ภงด3 ภงด53",
      },
      { label: "รอบยื่นแบบ ภ.ง.ด.", href: "/admin/wht/filings", icon: Receipt, permission: "wht_filings.view", keywords: "wht filing ยื่นแบบ ภงด3 ภงด53 ภ.ง.ด.3 ภ.ง.ด.53 ใบแนบ นำส่ง rdprep",
      },
      { label: "ข้อมูลภาษีผู้ถูกหัก", href: "/admin/wht/payees", icon: Receipt, permission: "wht.view", keywords: "wht payee ผู้ถูกหักภาษี ข้อมูลภาษี ผู้รับเงิน เลขผู้เสียภาษี",
      },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "กระทบยอดรับเงิน Shopee", href: "/admin/sales/shopee/settlements", icon: WalletCards, permission: "marketplace.manage", keywords: "shopee settlement payout กระทบยอด รับเงิน ค่าธรรมเนียม",
      },
      { label: "กระทบยอดรับเงิน Lazada", href: "/admin/sales/lazada/settlements", icon: WalletCards, permission: "marketplace.manage", keywords: "lazada settlement payout กระทบยอด รับเงิน ค่าธรรมเนียม ลาซาด้า",
      },
    ],
  },
  {
...
export const flattenAdminNavigation = (navigation: readonly AdminNavSection[],
): AdminNavItem[] =>
