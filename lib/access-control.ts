...
export const PERMISSION_CATALOG: readonly PermissionCatalogItem[] = [
  ...
  { key: "price_lists.view", group: "ราคาและโปรโมชั่น", label: "ดู Price List" },
  { key: "price_lists.create", group: "ราคาและโปรโมชั่น", label: "เพิ่ม Price List" },
  { key: "price_lists.update", group: "ราคาและโปรโมชั่น", label: "แก้ไข Price List" },
  { key: "price_lists.cancel", group: "ราคาและโปรโมชั่น", label: "ปิดใช้งาน Price List" },
