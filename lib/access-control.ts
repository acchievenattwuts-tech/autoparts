...
export const PERMISSION_CATALOG: readonly PermissionCatalogItem[] = [
  ...
  { key: "price_lists.view", group: "ราคาและโปรโมชั่น", label: "ดูระดับราคา" },
  { key: "price_lists.create", group: "ราคาและโปรโมชั่น", label: "เพิ่มระดับราคา" },
  { key: "price_lists.update", group: "ราคาและโปรโมชั่น", label: "แก้ไขระดับราคา" },
  { key: "price_lists.cancel", group: "ราคาและโปรโมชั่น", label: "ปิดใช้งานระดับราคา" },
  { key: "price_promotions.view", group: "ราคาและโปรโมชั่น", label: "ดูโปรโมชั่นราคา" },
  { key: "price_promotions.create", group: "ราคาและโปรโมชั่น", label: "สร้างโปรโมชั่นราคา" },
  { key: "price_promotions.update", group: "ราคาและโปรโมชั่น", label: "แก้ไขโปรโมชั่นราคา" },
  { key: "price_promotions.publish", group: "ราคาและโปรโมชั่น", label: "เผยแพร่โปรโมชั่นราคา" },
  { key: "price_promotions.cancel", group: "ราคาและโปรโมชั่น", label: "ยกเลิกโปรโมชั่นราคา" },
  ...
  { key: "wht.view", group: "ระบบงาน", label: "ดูภาษีหัก ณ ที่จ่าย" },
  { key: "wht.create", group: "ระบบงาน", label: "บันทึกภาษีหัก ณ ที่จ่าย" },
  { key: "wht.update", group: "ระบบงาน", label: "แก้ไขภาษีหัก ณ ที่จ่าย" },
  { key: "wht.cancel", group: "ระบบงาน", label: "ยกเลิกภาษีหัก ณ ที่จ่าย" },
  { key: "wht_filings.view", group: "ระบบงาน", label: "ดูแบบยื่น ภ.ง.ด." },
  { key: "wht_filings.manage", group: "ระบบงาน", label: "จัดทำและนำส่งแบบ ภ.ง.ด." },
  ...
  { key: "line_ai_keys.view", group: "LINE OA", label: "ดูสถานะ AI API Key (Gemini)" },
  { key: "line_ai_keys.manage", group: "LINE OA", label: "รีเซ็ต/เปิดใช้ AI API Key (Gemini)" },
...
export const ADMIN_ROUTE_RULES: Array<{ prefix: string; permission: PermissionKey | null }> = [
  ...
  { prefix: "/admin/pricing/price-lists", permission: "price_lists.view" },
  { prefix: "/admin/pricing/promotions", permission: "price_promotions.view" },
  ...
  { prefix: "/admin/wht/filings", permission: "wht_filings.view" },
  { prefix: "/admin/wht", permission: "wht.view" },
