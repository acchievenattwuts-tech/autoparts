...
const SOURCE_ROUTE_BUILDERS: Record<string, (entityId: string) => string> = {
  ...
  SalesQuotation: (entityId) => `/admin/sales-quotations/${entityId}`,
...
const ACTION_LABELS: Record<AuditAction, string> = {
  CANCEL: "ยกเลิก",
  CREATE: "สร้าง",
  CUSTOMER_VIEW_INVOICE_PDF: "ลูกค้าดูใบแจ้งหนี้ PDF",
  CUSTOMER_VIEW_RECEIPT_PDF: "ลูกค้าดูใบเสร็จ PDF",
  DELETE: "ลบ",
  EXPORT: "ส่งออก",
  LOGIN: "เข้าสู่ระบบ",
  LOGIN_FAILED: "เข้าสู่ระบบไม่สำเร็จ",
  LINE_LINK: "ผูก LINE",
  LINE_LINK_AMBIGUOUS: "เบอร์ LINE ซ้ำ",
  LINE_LINK_BLOCKED: "บล็อกผูก LINE",
  LINE_REGISTER: "สมัครผ่าน LINE",
  LOGOUT: "ออกจากระบบ",
...
const ACTION_BADGE_CLASSES: Record<AuditAction, string> = {
  ...
  CUSTOMER_VIEW_INVOICE_PDF: "bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-200",
  CUSTOMER_VIEW_RECEIPT_PDF: "bg-blue-100 text-blue-700 dark:bg-blue-500/15 dark:text-blue-200",
  ...
  LINE_LINK: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-200",
  LINE_LINK_AMBIGUOUS: "bg-amber-100 text-amber-700 dark:bg-amber-500/15 dark:text-amber-200",
  LINE_LINK_BLOCKED: "bg-rose-100 text-rose-700 dark:bg-rose-500/15 dark:text-rose-200",
  LINE_REGISTER: "bg-teal-100 text-teal-700 dark:bg-teal-500/15 dark:text-teal-200",
