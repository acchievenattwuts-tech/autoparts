...
const SHOP_INFO_RE =
  /(เวลาทำการ|เวลาเปิด|เปิดกี่โมง|กี่โมง|ปิดกี่โมง|เปิดไหม|ปิดไหม|หยุดไหม|วันหยุด|ติดต่อร้าน|ติดต่อสอบถาม|ขอสอบถามข้อมูล|เบอร์โทร|เบอร์ร้าน|ร้านอยู่ไหน|ร้านอยู่ที่ไหน|อยู่ที่ไหน|อยู่ตรงไหน|ที่ตั้งร้าน|ที่ตั้ง|พิกัด|แผนที่|ไปร้าน|ไปยังไง|ไปไง|มีหน้าร้าน|มีสาขา|สาขา|location|map)/i;
