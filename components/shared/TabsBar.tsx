...
const ROUTE_LABELS: Record<string, string> = {
  ...
  "/admin/pricing/price-lists": "ระดับราคา",
  "/admin/pricing/promotions": "โปรโมชั่นราคา",
  ...
  "/admin/master/customer-types": "ประเภทลูกค้า",
  "/admin/master/search-synonyms": "คลังคำพ้อง",
  ...
  "/admin/supplier-advance-refunds": "รับคืนเงินมัดจำซัพพลายเออร์",
  ...
  "/admin/line-ai-keys": "AI Keys (Gemini)",
  ...
  "/admin/wht/certificates": "หนังสือรับรอง 50 ทวิ",
  "/admin/wht/filings": "รอบยื่นแบบ ภ.ง.ด.",
  "/admin/wht/payees": "ข้อมูลภาษีผู้ถูกหัก",
  "/admin/wht": "ภาษีหัก ณ ที่จ่าย",
  "/admin/delivery-commissions": "ทำจ่ายค่าส่งพนักงาน",
  "/admin/profit-distributions": "แบ่งกำไรผู้ร่วมทุน",
  "/admin/profit-distributions/partners": "ผู้ร่วมทุน",
  ...
  "/admin/backup-center": "Backup Center",
