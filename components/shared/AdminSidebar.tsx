    ...
    <div className="flex h-full w-72 flex-col border-r border-[#163055]/20 bg-[#17365d] text-white shadow-xl dark:border-white/10 dark:bg-[#0b1424]">
      <div className="flex items-center justify-between border-b border-white/10 px-4 py-4 dark:border-white/10">
        <div className="min-w-0">
          ...
          <p className="mt-0.5 text-xs text-sky-100/75 dark:text-slate-400">ระบบจัดการหลังบ้าน</p>
        </div>
        {onClose && (
          <button
            onClick={onClose}
            aria-label="Close admin navigation"
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg transition-colors hover:bg-white/10 lg:hidden"
          >
            <X size={20} />
          </button>
        )}
              ...
              <button
                ...
                className={cn(
                  ...
                  hasActiveItem
                    ...
                    : "text-sky-100/70 hover:bg-white/8 hover:text-white dark:text-slate-400 dark:hover:bg-white/6 dark:hover:text-slate-300"
                )}
              >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive(sub.href)
                        ...
                        : "text-sky-50/90 hover:bg-white/10 hover:text-white dark:text-slate-300 dark:hover:bg-white/8"
                    )}
                  >
