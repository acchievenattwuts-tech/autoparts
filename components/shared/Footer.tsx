        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(320px,420px)] lg:items-start lg:justify-between">
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              ...
              {shopeeEnabled && shopeeUrl && <a href={shopeeUrl} target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg bg-white transition-opacity hover:opacity-80" aria-label="Shopee"><ShopeeLogoIcon className="h-5 w-5" /></a>}
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2.5">
                ...
                <div className="text-sm text-gray-400">
                  ...
                  {shopGoogleMapUrl && (
                    <a
                      href={shopGoogleMapUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-2 inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-[#1e3a5f] transition-colors hover:bg-[#f3f4f6]"
                    >
                      เปิด Google Maps
