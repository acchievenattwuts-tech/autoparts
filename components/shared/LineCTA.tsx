          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <a
                ...
                className="flex items-center justify-center gap-2 rounded-full bg-[#06C755] px-8 py-4 text-lg font-bold text-white shadow-lg shadow-green-900/40 transition-all hover:scale-105 hover:bg-[#05a847]"
              >
