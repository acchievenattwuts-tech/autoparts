...
const LineCTA = ({
  ...
  return (
    <section className="relative overflow-hidden bg-[#1e3a5f] py-20">
      <div className="absolute right-0 top-0 h-80 w-80 translate-x-1/2 -translate-y-1/2 rounded-full bg-[#f97316] opacity-10 blur-3xl" />
      <div className="absolute bottom-0 left-0 h-64 w-64 -translate-x-1/2 translate-y-1/2 rounded-full bg-[#06C755] opacity-10 blur-3xl" />

      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-between gap-12 lg:flex-row">
          <div className="text-center lg:text-left">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#06C755]/30 bg-[#06C755]/20 px-4 py-1.5">
              <span className="h-2 w-2 animate-pulse rounded-full bg-[#06C755]" />
              <span className="text-sm font-medium text-[#06C755]">พร้อมให้บริการทุกวัน</span>
            </div>
            ...
            <p className="mt-3 text-sm font-medium text-white/82">{shopName}</p>
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <a
                ...
                className="sf-shine flex items-center justify-center gap-2 rounded-full bg-[#06C755] px-8 py-4 text-lg font-bold text-white shadow-lg shadow-green-900/40 transition-all hover:scale-105 hover:bg-[#05a847]"
              >
              ...
              <a
                href={shopPhone ? `tel:${shopPhone}` : lineTarget}
                target={shopPhone ? undefined : "_blank"}
                rel={shopPhone ? undefined : "noopener noreferrer"}
                className="flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/10 px-8 py-4 text-lg font-semibold text-white transition-all hover:bg-white/20"
              >
                โทรสอบถาม
              </a>
            </div>
          ...
          <div className="flex-shrink-0">
            <div className="w-64 rounded-3xl bg-white p-8 text-center shadow-2xl">
              ...
              <p className="text-sm font-medium text-[#06C755]">{lineId}</p>
              <p className="mt-2 text-xs text-gray-400">สแกน QR เพื่อเพิ่มเพื่อนทาง LINE</p>
            </div>
          </div>
        </div>
      </div>
