 ...
 *   Shopee = salePrice × 1.40                 ปัดขึ้นลงท้ายด้วย 5 หรือ 0 (เพิ่มขึ้นเสมอ)
...
async function main(): Promise<void> {
  ...
  console.log("=".repeat(90));
  console.log("สูตร: Shopee = ขายส่ง x 1.40, Lazada = (ขายส่ง + 60) / 0.7218");
      ...
      async (tx) => {
        ...
        await tx.auditLog.create({
          data: {
            ...
            meta: {
              rule: "shopee = salePrice * 1.40, lazada = (salePrice + 60) / 0.7218, round up to next multiple of 5",
